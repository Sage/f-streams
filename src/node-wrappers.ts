...
export class HttpProxyClientRequest {
	...
	proxyConnect() {
		...
		if (options.isHttps) {
			...
			return wait(new Promise<HttpClientRequest>((resolve, reject) => {
				const proxyOpt = {
...
exports.usingReadable = function (this: any, emitter: NodeJS.ReadableStream, options?: ReadableOptions, fn?: (stream: any) => any) {
...
exports.usingWritable = function (this: any, emitter: NodeJS.WritableStream, options?: WritableOptions, fn?: (stream: any) => any) {
